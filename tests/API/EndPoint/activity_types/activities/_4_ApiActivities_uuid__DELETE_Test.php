...
class _4_ApiActivities_uuid__DELETE_Test extends AAMethodTest {
    public function test(): void {
        ...
        try {
             static::createClient()->request($method, $path, ['query' => ['deletedAt'=>'false'], 'headers' => ['Accept' => 'application/json', 'Authorization' => 'Bearer '.self::$token], 'json' => $data]);
